//
//  SPTabNavigationController.swift
//  SwiftHelper (iOS)
//
...
class SPTabNavigationController: UITabBarController {
...
//        tabBar.backgroundImage = UIImage()
    ...
    func configureTabBar() {
        ...
        let vc1 = makeTabBarViewController(viewController: UIKitViewController(), title: "UIKit", image: UIImage(systemName: "circle"), selectedImage: UIImage(systemName: "circle.fill"))
        vcs.append(vc1)
...
struct TabBarViewController_Previews: PreviewProvider {
    static var previews: some View {
        PlatformViewControllerRepresent(SPTabNavigationController()).ignoresSafeArea()
    }
}
