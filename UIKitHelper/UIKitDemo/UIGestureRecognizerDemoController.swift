...
class UIGestureRecognizerDemoController: SUIBaseViewController {
    private var tableView: UITableView!
    private var sections: [SUISection<String, [UIGestureRecognizerType]>] = [SUISection("section1", value: UIGestureRecognizerType.allCases)]
...
extension UIGestureRecognizerDemoController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = sections[indexPath.section].value[indexPath.row].rawValue
        return cell
    }
}
