...
class UITableViewDemoController: SUIBaseViewController {
    private var tableView: UITableView!
    private var sections: [SUISection<String, [String]>] = [SUISection("section1", value: Array<String>(repeating: "section1 item", count: 20)), SUISection("section2", value: Array<String>(repeating: "section2 item", count: 20))]
...
extension UITableViewDemoController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        switch editingStyle {
        case .delete:
            sections[indexPath.section].value.remove(at: indexPath.row)
        case .insert:
            break
        case .none:
            break
