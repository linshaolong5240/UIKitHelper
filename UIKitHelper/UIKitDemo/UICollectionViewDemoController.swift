...
class UICollectionViewDemoController: SUIBaseViewController {
    private let sections: [SUISection<String, [UIColor]>] = [SUISection("section1", value: [UIColor].demoColors), SUISection("section2", value: [UIColor].demoColors)]
